...
class NetblockPutWorkspace(Transform):
    """ PUT Maltego properties to Metasploit workspace. NEEDS TO BE A WORKSPACE !"""

    display_name = 'PUT Netblock workspace'
    transform_set = 'Metasploit | Workspace | Update'
    input_type = Netblock 
...
class NetblockGetWorkspace(Transform):
    """ GET Metasploit properties to Maltego workspace. NEEDS TO BE A WORKSPACE !"""

    display_name = 'GET Netblock Workspace'
    transform_set = 'Metasploit | Netblock.Workspace | Update'
    input_type = Netblock 
    ...
    def do_transform(self, request, response, config):
        ...
        try:
            ...
            raise MaltegoException("This Netblock/Host is not tied to a Metasploit Workspace. Please associate it with a workspace before running this transform")
            return response
...
class NetblockDeleteWorkspace(Transform):
    ...
    display_name = 'DELETE Netblock Workspace'
    transform_set = 'Metasploit | Netblock.Workspace | Update'
    input_type = Netblock 
