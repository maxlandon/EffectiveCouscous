...
# Base Transforms
from EffectiveCouscous.transforms.metasploit.base.db.get_post.netblock import (NetblockPutWorkspace,
...
class HostPutWorkspace(NetblockPutWorkspace):
    """ PUT Maltego properties to Metasploit workspace."""
...
class HostGetWorkspace(NetblockGetWorkspace):
    """ GET Metasploit properties to Maltego workspace."""
...
class PutHost(Transform):
    """ PUT Maltego properties to Metasploit Host"""
    
    display_name = 'PUT Host'
    transform_set = 'Metasploit | Host | Update'
    input_type = MetasploitHost
...
class GetHost(Transform):
    """ GET Metasploit properties to Maltego Host"""
