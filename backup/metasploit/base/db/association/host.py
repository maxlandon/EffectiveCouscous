...
# Base Transforms
from EffectiveCouscous.transforms.metasploit.base.db.association.netblock import NetblockToMetasploitWorkspace
...
class HostToMetasploitWorkspace(NetblockToMetasploitWorkspace):
    ...
    transform_set = 'Metasploit | Host | Association'
