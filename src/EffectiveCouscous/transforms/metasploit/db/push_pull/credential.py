...
# Custom Entities
from EffectiveCouscous.transforms.common.entities import MetasploitCredential
...
class PushCredential(Transform):
    """Push Maltego properties to Metasploit Credential."""

    display_name = 'Push Credential'
    transform_set = 'Metasploit | DB | Credential'
...
class PullCredential(Transform):
    """ Pull Metasploit properties to Maltego Credential"""

    display_name = 'Pull Credential'
    transform_set = 'Metasploit | DB | Credential'
    input_type = MetasploitCredential
